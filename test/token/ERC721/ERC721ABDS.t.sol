...
import {ERC721ABDS} from "src/token/ERC721/ERC721ABDS.sol";
...
import {ERC721ABDSTestData} from "test/_testdata/ERC721ABDS.td.sol";
...
contract ERC721ABDSTest is Test, ERC721ABDSTestData {
    ...
    function setUp() public {
        ...
        erc721DSImpl = new ERC721ABDS();
        vm.label(address(erc721DSImpl), "erc721DSImpl");
    ...
    function test_initDrop_owner() public {
        ...
        nft.initDrop(MAX_UNITS, SHARE_PER_TOKEN, MINT_GENESIS, genesisRecipient, address(royaltyToken), URI);
    ...
    function test_initDrop_noGenesisMint() public {
        vm.prank(publisher);
        nft.initDrop(MAX_UNITS, SHARE_PER_TOKEN, 0, genesisRecipient, address(royaltyToken), URI);
    ...
    function test_symbol_initialized() public {
        vm.startPrank(publisher);
        nft.initDrop(MAX_UNITS, SHARE_PER_TOKEN, 2, genesisRecipient, address(royaltyToken), URI);
    ...
    function test_tokenURI_nonUnique() public {
        ...
        vm.prank(publisher);
        nft.initDrop(MAX_UNITS, SHARE_PER_TOKEN, MINT_GENESIS, genesisRecipient, address(royaltyToken), tokenURI);
    ...
    function test_tokenURI_unminted() public {
        ...
        vm.prank(publisher);
        nft.initDrop(MAX_UNITS, SHARE_PER_TOKEN, 0, genesisRecipient, address(royaltyToken), tokenURI);
