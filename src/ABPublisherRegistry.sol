...
/**
 * @title ABPublisherRegistry
 * @author Anotherblock Technical Team
 * @notice Anotherblock Publisher Registry contract responsible for housekeeping publisher details
 *
 */
...
contract ABPublisherRegistry is Ownable {
    // /**
    //  * @notice
    //  *  Drop Structure format
    //  *
    //  * @param publisherId publisher identifier
    //  * @param account publisher account address
    //  * @param abRoyalty ABRoyalty address associated to the publisher
    //  */
    // struct Publisher {
    //     address abRoyalty;
    // }
