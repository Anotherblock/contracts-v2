...
interface IABKYCModule {
     ...
     */
    function onMint(address _user, bytes calldata _signature) external;
     ...
     */
    function onTransfer(address _to) external;
     ...
     * @param _signature signature generated by AB Backend and signed by AB KYC Signer
     */
    function onRoyaltyClaim(address _user, bytes calldata _signature) external;
