...
contract ABKYCModule is IABKYCModule, AccessControlUpgradeable {
     ...
     */
    function onMint(address _user, bytes calldata _signature) external view {
     ...
     */
    function onTransfer(address _to) external view {}
     ...
     * @param _signature signature generated by AB Backend and signed by AB KYC Signer
     */
    function onRoyaltyClaim(address _user, bytes calldata _signature) external view {}
