...
contract ABKYCModule is IABKYCModule, AccessControlUpgradeable {
     ...
     */
    function onMint(address _user, bytes calldata _signature) external view returns (bool _isValid) {
     ...
     * @return _isValid boolean corresponding to the user's KYC approval
     */
    function onTransfer(address _to) external view returns (bool _isValid) {}
     ...
     * @return _isValid boolean corresponding to the user's KYC approval
     */
    function onRoyaltyClaim(address _user, bytes calldata _signature) external view returns (bool _isValid) {}
